...
%
\verbatiminput{examples/example-0112/results/results.summary}
\verbatiminput{examples/example-0112/results/failed.tests}
%
...
\begin{figure}[h!]
    \centering 
%    \includegraphics[width=\columnwidth]{examples/example-0112/doc/figures/l160x120x000_n32x24x00_i1_s0_shear.png} 
...
\begin{figure}[h!]
    \centering 
%    \includegraphics[width=\columnwidth]{examples/example-0112/doc/figures/l160x120x120_n32x24x24_i1_s0_shear.png} 
