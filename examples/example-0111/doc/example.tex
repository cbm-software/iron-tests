...
%
\verbatiminput{examples/example-0111/results/results.summary}
\verbatiminput{examples/example-0111/results/failed.tests}
%
...
\begin{figure}[h!]
    \centering
%    \includegraphics[width=0.9\columnwidth]{examples/example-0111/doc/figures/l160x120x000_n32x24x00_i1_s0.png}
...
\begin{figure}[h!]
    \centering
%    \includegraphics[width=0.9\columnwidth]{examples/example-0111/doc/figures/l160x120x120_n32x24x24_i1_s0.png}
