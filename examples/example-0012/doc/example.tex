...
\begin{itemize}
    ...
    \item{Commandline arguments for tests are:}
        \subitem{2.0 1.0 0.0 2 1 0 1 0 2 3 0 0 0 0}
        \subitem{2.0 1.0 0.0 4 2 0 1 0 2 3 0 0 0 0}
        \subitem{2.0 1.0 0.0 8 4 0 1 0 2 3 0 0 0 0}
        \subitem{2.0 1.0 0.0 2 1 0 2 0 2 3 0 0 0 0}
        \subitem{2.0 1.0 0.0 4 2 0 2 0 2 3 0 0 0 0}
        \subitem{2.0 1.0 0.0 8 4 0 2 0 2 3 0 0 0 0}
        \subitem{2.0 1.0 0.0 2 1 0 1 1 2 3 0 0 0 0}
        \subitem{2.0 1.0 0.0 4 2 0 1 1 2 3 0 0 0 0}
        \subitem{2.0 1.0 0.0 8 4 0 1 1 2 3 0 0 0 0}
        \subitem{2.0 1.0 0.0 2 1 0 2 1 2 3 0 0 0 0}
        \subitem{2.0 1.0 0.0 4 2 0 2 1 2 3 0 0 0 0}
        \subitem{2.0 1.0 0.0 8 4 0 2 1 2 3 0 0 0 0}
        \subitem{2.0 1.0 1.0 2 1 1 1 0 2 3 7 0 0 0}
        \subitem{2.0 1.0 1.0 4 2 2 1 0 2 3 7 0 0 0}
        \subitem{2.0 1.0 1.0 8 4 4 1 0 2 3 7 0 0 0}
        \subitem{2.0 1.0 1.0 2 1 1 2 0 2 3 7 0 0 0}
        \subitem{2.0 1.0 1.0 4 2 2 2 0 2 3 7 0 0 0}
        \subitem{2.0 1.0 1.0 8 4 4 2 0 2 3 7 0 0 0}
        \subitem{2.0 1.0 1.0 2 1 1 1 1 2 3 7 0 0 0}
        \subitem{2.0 1.0 1.0 4 2 2 1 1 2 3 7 0 0 0}
        \subitem{2.0 1.0 1.0 8 4 4 1 1 2 3 7 0 0 0}
        \subitem{2.0 1.0 1.0 2 1 1 2 1 2 3 7 0 0 0}
        \subitem{2.0 1.0 1.0 4 2 2 2 1 2 3 7 0 0 0}
        \subitem{2.0 1.0 1.0 8 4 4 2 1 2 3 7 0 0 0}
\end{itemize}
%
%===============================================================================
%
...
%
\verbatiminput{examples/example-0012/results/results.summary}
\verbatiminput{examples/example-0012/results/failed.tests}
%
\begin{figure}[h!]
    \centering 
...
\begin{figure}[h!]
    \centering 
    \includegraphics[width=0.9\columnwidth]{examples/example-0012/doc/figures/current_run_l2x1x0_n8x4x0_i1_s0.eps} 
...
\begin{figure}[h!]
    \centering 
    \includegraphics[width=0.9\columnwidth]{examples/example-0012/doc/figures/current_run_l2x1x1_n8x4x4_i1_s0.eps} 
