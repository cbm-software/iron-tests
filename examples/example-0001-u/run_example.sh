...
mkdir -p results/current_run/l2x1x0_n8x4x0_i7_s0 && ./bin/example 2.0 1.0 0.0 8 4 0 7 0
mkdir -p results/current_run/l2x1x0_n8x4x0_i8_s0 && ./bin/example 2.0 1.0 0.0 8 4 0 8 0
...
mkdir -p results/current_run/l2x1x0_n8x4x0_i7_s1 && ./bin/example 2.0 1.0 0.0 8 4 0 7 1
mkdir -p results/current_run/l2x1x0_n8x4x0_i8_s1 && ./bin/example 2.0 1.0 0.0 8 4 0 8 1
echo "    3D tests"
...
mkdir -p results/current_run/l2x1x1_n8x4x4_i7_s0 && ./bin/example 2.0 1.0 1.0 8 4 4 7 0
mkdir -p results/current_run/l2x1x1_n8x4x4_i8_s0 && ./bin/example 2.0 1.0 1.0 8 4 4 8 0
...
mkdir -p results/current_run/l2x1x1_n8x4x4_i7_s1 && ./bin/example 2.0 1.0 1.0 8 4 4 7 1
mkdir -p results/current_run/l2x1x1_n8x4x4_i8_s1 && ./bin/example 2.0 1.0 1.0 8 4 4 8 1
